::  Windows Installer - The Lounge Chat 4.3.0
::  Version 4.3.0
::  Created by aab12345
::  Last Updated: 22/10/2021

@ECHO OFF
TITLE The Lounge Chat 4.3.0 Installer
COLOR 03
ECHO.
ECHO  ------------------------------------
ECHO    The Lounge 4.3.0 Full Installer
ECHO  ------------------------------------
ECHO.
...
ECHO.
ECHO  -----------------------------------
ECHO    The Lounge 4.3.0 Install 1 of 6
ECHO  -----------------------------------
ECHO.
...
RMDIR /S /Q "C:\Program Files\TLC4.3.0" >nul 2>&1
...
XCOPY "Readme.txt" "C:\Program Files\TLC4.3.0" /S /D >nul 2>&1
ping 127.0.0.1 -n 6 > nul
CLS
ECHO.
COLOR 03
ECHO  -----------------------------------
ECHO    The Lounge 4.3.0 Install 2 of 6
ECHO  -----------------------------------
ECHO.
...
COLOR 06
ECHO  -----------------------------------
ECHO    The Lounge 4.3.0 Install 3 of 6
ECHO  -----------------------------------
ECHO.
...
COLOR 03
ECHO  -----------------------------------
ECHO    The Lounge 4.3.0 Install 4 of 6
ECHO  -----------------------------------
ECHO.
ECHO  Building Lounge Chat 4.3.0 Package.  
ECHO  Please wait...
ECHO.
...
COLOR 07
ECHO  -----------------------------------
ECHO    The Lounge 4.3.0 Install 5 of 6
ECHO  -----------------------------------
ECHO.
ECHO  Copying Files to Desktop.  
ECHO  Please wait...
ECHO.
MKDIR "C:\Users\%username%\Desktop\TLC4.3.0" > nul 
XCOPY "C:\Program Files\TLC4.3.0\Private.bat" "C:\Users\%username%\Desktop\TLC4.3.0" /S /D > nul
XCOPY "C:\Program Files\TLC4.3.0\Public.bat" "C:\Users\%username%\Desktop\TLC4.3.0"  /S /D > nul
XCOPY "C:\Program Files\TLC4.3.0\Readme.txt" "C:\Users\%username%\Desktop\TLC4.3.0"  /S /D > nul
CLS
ECHO.
ECHO  -----------------------------------
ECHO    The Lounge 4.3.0 Install 6 of 6
ECHO  -----------------------------------
ECHO.
ECHO  The installation has completed.
ECHO  This readme file is located on the desktop in the TLC4.3.0 folder.
ECHO.
